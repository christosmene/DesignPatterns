...
namespace Exercise
{
    ...
    class Program
    {
        public static void Main()
        {
            ...
            Console.WriteLine(new Square(new VectorRenderer()));
            //Is.EqualTo("Drawing Square as lines"));

            Console.WriteLine(new Square(new RasterRenderer()));
            //Is.EqualTo("Drawing Square as pixels"));


            Console.WriteLine(new Triangle(new VectorRenderer()));
            //Is.EqualTo("Drawing Triangle as lines"));

            Console.WriteLine(new Triangle(new RasterRenderer()));
            //Is.EqualTo("Drawing Triangleas pixels"));
        }
    }
}
